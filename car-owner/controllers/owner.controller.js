            ...
            { $limit: limit },
            {
                $project: {
                    ...
                    serviceDetails: {
                        ...
                        categoryDescription: "$serviceDetails.description",
                    },
                    mechanicDetails: 1,
                },
            },
...
export const postCancelBooking = async (req, res) => {
    ...
    try {
        ...
        let updatePayload = {
            ...
            cancelReason: reason,
            cancelTime: new Date(),
            cancellationPercentage: cancellationCharge,
...
export const postTransactionDetails = async (req, res) => {
    try {
        ...
        log1(["postTransactionDetails ownerId----->", ownerId]);
        log1(["postTransactionDetails req.body----->", req.body]);
